...
ORG 100h
	...
	napispierwsza db "Podaj liczbe$"
	napisdruga db "Podaj druga liczbe$"

	suma db Buflen

	temp DB buflen+2 DUP('.')
...
;;; zamienic kolejnosc stacku
	...
	mov bx,0 		;bx bedzie suma
	push bx
	

	pop bx 			;pierwszaliczba
	pop ax
	add bx, ax
	push bx
	call printax
...
; teraz w AX jest odebrana liczba skonwertowana z napisu
	...
	mov bx, ax 		;liczba przygotowana do wrzucenia na stack
